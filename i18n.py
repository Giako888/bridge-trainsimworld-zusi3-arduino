...
TRANSLATIONS = {
    ...
    # --- EBuLa Recorder ---
    "btn_rec_start":        {"it": "⏺ Registra Tratta",   "en": "⏺ Record Route",     "de": "⏺ Strecke aufnehmen"},
    "btn_rec_stop":         {"it": "⏹ Stop Registrazione", "en": "⏹ Stop Recording",   "de": "⏹ Aufnahme stoppen"},
    "btn_rec_convert":      {"it": "🔄 Converti → EBuLa", "en": "🔄 Convert → EBuLa", "de": "🔄 Konvertieren → EBuLa"},
    "rec_idle":             {"it": "Pronto per registrare", "en": "Ready to record",   "de": "Aufnahmebereit"},
    "rec_recording":        {"it": "⏺ REC — {samples} camp. — {km:.1f} km — {time}",
                             "en": "⏺ REC — {samples} samp. — {km:.1f} km — {time}",
                             "de": "⏺ REC — {samples} Samp. — {km:.1f} km — {time}"},
    "rec_stopped":          {"it": "Registrazione: {samples} campioni, {km:.1f} km",
                             "en": "Recording: {samples} samples, {km:.1f} km",
                             "de": "Aufnahme: {samples} Samples, {km:.1f} km"},
    "rec_saved":            {"it": "Registrazione salvata: {path}",
                             "en": "Recording saved: {path}",
                             "de": "Aufnahme gespeichert: {path}"},
    "rec_save_error":       {"it": "Errore salvataggio registrazione",
                             "en": "Recording save error",
                             "de": "Fehler beim Speichern der Aufnahme"},
    "rec_converting":       {"it": "Conversione in corso...",
                             "en": "Converting...",
                             "de": "Konvertierung..."},
    "rec_convert_done":     {"it": "EBuLa generato: {entries} voci, {stops} fermate — {path}",
                             "en": "EBuLa generated: {entries} entries, {stops} stops — {path}",
                             "de": "EBuLa erstellt: {entries} Einträge, {stops} Halte — {path}"},
    "rec_convert_error":    {"it": "Errore conversione EBuLa",
                             "en": "EBuLa conversion error",
                             "de": "Fehler bei EBuLa-Konvertierung"},
    "rec_no_recording":     {"it": "Nessuna registrazione da convertire",
                             "en": "No recording to convert",
                             "de": "Keine Aufnahme zum Konvertieren"},
    "rec_need_tsw6":        {"it": "Connetti TSW6 prima di registrare",
                             "en": "Connect TSW6 before recording",
                             "de": "TSW6 verbinden vor Aufnahme"},
    "rec_select_file":      {"it": "Salva registrazione come...",
                             "en": "Save recording as...",
                             "de": "Aufnahme speichern als..."},
    "rec_select_ebula":     {"it": "Salva EBuLa come...",
                             "en": "Save EBuLa as...",
                             "de": "EBuLa speichern als..."},
