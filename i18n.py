...
TRANSLATIONS = {
    ...
    "profile_desc_br101":   {"it": "BR 101 — PZB/LZB/SIFA con pannello MFA",
                             "en": "BR 101 — PZB/LZB/SIFA with MFA panel",
                             "de": "BR 101 — PZB/LZB/SIFA mit MFA-Anzeige"},
    ...
    "profile_desc_bpmmbdzf":{"it": "Carrozza pilota — stessi indicatori MFA della BR101",
                             "en": "Cab car — same MFA indicators as BR101",
                             "de": "Steuerwagen — gleiche MFA-Anzeigen wie BR101"},
